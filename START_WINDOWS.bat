...
%PYTHON_CMD% -m pip install flask yt-dlp "moviepy==1.0.3" Pillow numpy imageio imageio-ffmpeg python-dotenv pyyaml "rich>=13.0.0" --quiet --no-warn-script-location
